...
<div class="page__section flex flex-col gap-4">
	<div class="card">
		...
		<div class="card__body">
			<p class="text-sm text-muted-foreground" style="margin:0 0 1rem;">Periksa kembali data proposal dan asset yang akan dipinjam sebelum mengajukan.</p>
