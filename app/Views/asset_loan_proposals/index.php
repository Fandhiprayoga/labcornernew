			...
			<div class="table-responsive">
				<table class="table">
					...
					<tbody><?php foreach ($proposals as $proposal): ?><tr>
								...
								<td class="text-end">
									<?php $allItemsTaken = (int) ($proposal['total_items'] ?? 0) > 0 && (int) ($proposal['taken_items'] ?? 0) >= (int) ($proposal['total_items'] ?? 0); ?>
