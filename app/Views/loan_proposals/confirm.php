  ...
  <div class="dialog__panel">
    <div class="dialog__content">
      ...
      <div class="dialog__body text-center pt-6">
        ...
        <h3 class="dialog__title mb-1" id="loanSubmitConfirmLabel">Ajukan proposal ini?</h3>
        <p class="text-muted-foreground" id="loanSubmitConfirmDesc">Data proposal akan dikirim untuk diproses setelah Anda mengonfirmasi.</p>
      </div>
