<div class="page__section">
  <div class="card" style="width: 100%;">
    ...
    <div class="card__body">
      <form action="<?= base_url('admin/laboratories/store') ?>" method="post" enctype="multipart/form-data" class="flex flex-col gap-4">
        <?= csrf_field() ?>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="field"><label for="photo" class="field__label">Foto Laboratorium</label><input type="file" class="input w-full" id="photo" name="photo" accept="image/jpeg,image/png,image/webp"><div class="text-xs text-muted-foreground">JPG, PNG, atau WebP. Maksimal 2 MB.</div></div>
