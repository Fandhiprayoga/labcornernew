  ...
  <div class="card">
    ...
    <div class="card__body p-0">
      <div class="table-responsive">
        <table class="table">
          <thead><tr><th class="text-center" style="width: 60px;">#</th><th>Kode</th><th>Program Studi</th><th>Fakultas</th><th>Jenjang</th><th>Status</th><th class="text-end">Aksi</th></tr></thead>
          <tbody>
...
<div class="dialog dialog--sm" id="studyProgramDeleteConfirm" data-state="closed" role="alertdialog" aria-modal="true" aria-labelledby="studyProgramDeleteConfirmLabel" aria-describedby="studyProgramDeleteConfirmDesc" aria-hidden="true" tabindex="-1">
  <div class="dialog__backdrop" data-study-program-dialog-dismiss></div>
  <div class="dialog__panel">
    <div class="dialog__content">
      <button type="button" class="dialog__close" data-study-program-dialog-dismiss aria-label="Tutup"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" aria-hidden="true"><path d="M6 6l12 12M18 6L6 18" /></svg></button>
      <div class="dialog__body text-center pt-6">
        ...
        <h3 class="dialog__title mb-1" id="studyProgramDeleteConfirmLabel">Hapus program studi?</h3>
        <p class="text-muted-foreground" id="studyProgramDeleteConfirmDesc">Program studi <strong id="studyProgramDeleteConfirmName"></strong> akan dihapus.</p>
      </div>
      <form id="studyProgramDeleteForm" method="post">
        <?= csrf_field() ?>
        <div class="dialog__footer justify-center">
          <button type="button" class="button button--outline button--neutral" data-study-program-dialog-dismiss>Batal</button>
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    var dialog = document.getElementById('studyProgramDeleteConfirm');
    var modalForm = document.getElementById('studyProgramDeleteForm');
    var name = document.getElementById('studyProgramDeleteConfirmName');

    document.querySelectorAll('[data-study-program-delete-form]').forEach(function (form) {
      form.addEventListener('submit', function (event) {
        ...
        window.requestAnimationFrame(function () { modalForm.querySelector('[data-study-program-dialog-dismiss]').focus(); });
      });
    });

    dialog.querySelectorAll('[data-study-program-dialog-dismiss]').forEach(function (element) {
