...
class AuthGroups extends ShieldAuthGroups
{
    ...
    public array $permissions = [
        ...
        // BHP submissions
        'bhp.access' => 'Dapat mengakses modul pengajuan BHP',
        'bhp.list' => 'Dapat melihat pengajuan BHP',
        'bhp.create' => 'Dapat membuat pengajuan BHP',
        'bhp.edit' => 'Dapat mengedit pengajuan BHP',
        'bhp.review' => 'Dapat meninjau pengajuan BHP',
        'bhp.disburse' => 'Dapat menandai anggaran BHP cair',
        'bhp.evidence' => 'Dapat mengunggah eviden BHP',
        'bhp.verify' => 'Dapat memverifikasi eviden BHP',
        'bhp.periods' => 'Dapat mengelola periode pengajuan BHP',
        'bhp.override' => 'Dapat melakukan override pengajuan BHP',
        'bhp.export' => 'Dapat mengekspor pengajuan BHP',
